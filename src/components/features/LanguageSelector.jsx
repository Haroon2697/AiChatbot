...
const LanguageSelector = ({ selectedLanguage, onLanguageChange, isDarkMode = false }) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className={`absolute top-full left-0 mt-1 w-48 rounded-lg shadow-lg z-50 transition-colors duration-200 ${
