        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Discover amazing features and build something incredible with our modern React application.
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg bg-white shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Robust and dependable solutions that you can count on.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-lg bg-white shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Intuitive design that makes your experience seamless and enjoyable.
              </p>
            </div>
          </div>
        </div>
